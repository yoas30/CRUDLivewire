    ...
    <div class="card">
        <div class="card-header">
            <div class="row">
                ...
                <div class="col"><a href="/add/new" wire:navigate class="btn btn-success btn-sm float-end">Add New</a></div>
            </div>
        </div>
        <div class="card-body">  
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td><button class="btn btn-danger btn-sm" wire:click='delete({{ $item->id }})' 
                                wire:confirm='Apakah yakin data akan dihapus?'>Delete</button></td>
                        <td>
